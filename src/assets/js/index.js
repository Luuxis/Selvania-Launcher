...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "pour votre securité tapé un golème.", "author": "Clément Martin" },
            { "message": "Qui est KRO", "author": "Clément Martin" },
            { "message": "Code secret dans le logo violet", "author": "Clément Martin" }
        ];
